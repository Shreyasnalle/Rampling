...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  return (
    ...
    >
      {/* Small subtle border effect without hover */}
      <div
        className="absolute inset-0 rounded-[inherit] pointer-events-none -z-[1] transition-opacity duration-300 ease-out"
        style={{
      ...
      <div className="flex flex-col relative overflow-hidden h-full w-full z-[1]">
        {children}
      </div>
    </div>
  );
